const ContactPage = () => {
  return (
    <div className="bg-secondary">
      ...
      <div
        className="grayscale"
        style={{ maxWidth: '100%', overflow: 'hidden', color: 'red', width: '100%', height: 500 }}
      >
        <div id="gmap-canvas" style={{ height: '100%', width: '100%', maxWidth: '100%' }}>
          <iframe
            style={{ height: '100%', width: '100%', border: 0 }}
            src="https://www.google.com/maps/embed/v1/place?q=Opalowa+3,+Lublin,+Poland&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8&zoom=18"
          />
        </div>
      </div>
    </div>
