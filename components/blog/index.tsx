        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              ...
              <h5 className="my-4 uppercase">
                The Rise of Jamstack Architecture in Front-End Development
              </h5>
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Explore the evolution of web development with Jamstack and discover why it&apos;s
        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              ...
              <h5 className="my-4 uppercase">
                Exploring the Magic of WebAssembly in Front-End Programming
              </h5>
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Uncover the wizardry of WebAssembly and its impact on front-end development, from
                speed optimizations to cross-language compatibility.
              </p>
              <a
                className="uppercase flex justify-center items-center border w-40 h-12 text-center my-4 border-gray hover:bg-secondary hover:text-primary"
                href="https://docs.google.com/document/d/1HLEmikSVbuDQt5rJklYaWjQ4HQBrsN2Q_YjZAr5ZJ-s/edit?usp=sharing"
        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              ...
              <h5 className="my-4 uppercase">
                Design Systems: Crafting Consistency in Front-End UI/UX
              </h5>
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Navigate the world of design systems and learn how they empower front-end developers
                to create consistent, user-friendly interfaces.
              </p>
              <a
                className="uppercase flex justify-center items-center border w-40 h-12 text-center my-4 border-gray hover:bg-secondary hover:text-primary"
                href="https://docs.google.com/document/d/1HLEmikSVbuDQt5rJklYaWjQ4HQBrsN2Q_YjZAr5ZJ-s/edit?usp=sharing"
        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              <div className="max-h-80 overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1514417034809-c7b296354f07?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                  className="align-middle h-auto"
                />
              </div>
              <h5 className="my-4 uppercase">
              ...
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Step into the world of Progressive Web Apps and understand how they offer a
                seamless, app-like experience across various devices.
              </p>
              <a
                className="uppercase flex justify-center items-center border w-40 h-12 text-center my-4 border-gray hover:bg-secondary hover:text-primary"
                href="https://docs.google.com/document/d/1HLEmikSVbuDQt5rJklYaWjQ4HQBrsN2Q_YjZAr5ZJ-s/edit?usp=sharing"
        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              ...
              <h5 className="my-4 uppercase">
                Dark Mode Design: Enhancing User Experience in Front-End Development
              </h5>
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Embrace the darkness! Explore the growing trend of dark mode design and how it can
                enhance user experience in front-end interfaces.
              </p>
              <a
                className="uppercase flex justify-center items-center border w-40 h-12 text-center my-4 border-gray hover:bg-secondary hover:text-primary"
                href="https://docs.google.com/document/d/1HLEmikSVbuDQt5rJklYaWjQ4HQBrsN2Q_YjZAr5ZJ-s/edit?usp=sharing"
        ...
        <div className="w-full lg:w-1/3 p-5">
          <div className="flex flex-row gap-4">
            ...
            <div className="post-right">
              ...
              <h5 className="my-4 uppercase">
                The Future of Front-End Development: Exploring Micro Frontends
              </h5>
              <p className="my-4 font-secondary font-light">NOVEMBER 21, 2013</p>
              <p className="font-secondary font-light">
                Peer into the crystal ball of front-end development and uncover the potential of
                micro frontends in building scalable and modular web applications.
              </p>
              <a
                className="uppercase flex justify-center items-center border w-40 h-12 text-center my-4 border-gray hover:bg-secondary hover:text-primary"
                href="https://docs.google.com/document/d/1HLEmikSVbuDQt5rJklYaWjQ4HQBrsN2Q_YjZAr5ZJ-s/edit?usp=sharing"
