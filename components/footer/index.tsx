        ...
        <div className="container mx-auto">
          ...
          <div className="flex flex-col items-center">
            <div className="my-12 z-0">
              <SocialIcon url="www.facebook.com" style={{ height: 35, width: 35}} className="m-6"/>
              <SocialIcon url="www.twitter.com" style={{ height: 35, width: 35 }} className="m-6"/>
              <SocialIcon url="www.instagram.com" style={{ height: 35, width: 35 }} className="m-6"/>
              <SocialIcon url="www.pinterest.com" style={{ height: 35, width: 35 }} className="m-6"/>
