...
const DesktopNav = () => {
  ...
  return (
    <ul className={`hidden ${isHomePage ? 'absolute' : 'sticky'} ${isHomePage ? 'bg-transparent' : 'bg-primary'}  top-0 z-20 w-screen sm:hidden h-30 lg:flex justify-center items-center font-primary text-base uppercase ${isHomePage ? 'text-primary' : 'text-secondary'}`}>
